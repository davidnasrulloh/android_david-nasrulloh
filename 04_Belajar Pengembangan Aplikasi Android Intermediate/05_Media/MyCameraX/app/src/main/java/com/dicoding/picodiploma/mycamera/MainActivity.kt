...
class MainActivity : AppCompatActivity() {
    ...
    private fun startGallery() {
        ...
        Toast.makeText(this, "Fitur intent galery dijalankan", Toast.LENGTH_SHORT).show()
    }

    // launcher intent galery
    ...
    private fun startTakePhoto() {
        ...
        Toast.makeText(this, "Proses Membuka Camera", Toast.LENGTH_SHORT).show()
    }

    // launcher camera biasa
