package com.davidnasrulloh.mymediaplayer
...
class MediaService : Service(), MediaPlayerCallback {
    ...
    companion object {
        const val ACTION_CREATE = "com.davidnasrulloh.mymediaplayer.create"
        const val ACTION_DESTROY = "com.davidnasrulloh.mymediaplayer.destroy"
