package com.davidnasrulloh.myreadwritefile
...
import com.davidnasrulloh.myreadwritefile.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun saveFile(){
        when{
            binding.editTitle.text.toString().isEmpty() -> Toast.makeText(this, "Title harus terisi terlebih dahulu", Toast.LENGTH_SHORT).show()
